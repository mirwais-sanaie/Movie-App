              ...
              <div className="grid w-full gap-3 sm:grid-cols-2 lg:grid-cols-4 items-center">
                {movie.homepage && (
                  ...
                  >
                    <Button
                      variant={"outline"}
                      className="w-full h-10  cursor-pointer py-3"
                    >
                      Website
                ...
                <Button
                  ...
                  className="w-full h-10 py-3 cursor-pointer shadow-md border border-red-300 hover:bg-red-50 transition-all duration-300 flex items-center justify-center"
                  onClick={
                    session?.user
